...
class Program
{
    static void Main(string[] args)
    {
        ...
        string[] Some_sad_words = { "lonely", "unmotivated", "heartbroken", "miserable", "depressed", "hopeless", "somber", "dejected" };
        ...
        foreach(var wrd in Some_happiness_triggers){
            HappinessTriggers_to_addList.Add(wrd);
        }
        foreach(var wrd in Some_sadness_triggers){
            SadnessTriggers_to_addList.Add(wrd);
        }
        ...
        Words_to_add.happiness_triggers(HappinessTriggers_to_addList);
        Words_to_add.sadness_triggers(SadnessTriggers_to_addList);   
    }
}
